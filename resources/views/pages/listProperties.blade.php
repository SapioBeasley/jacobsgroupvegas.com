				...
				<div class="pages-breadcrumb">
					<div class="container">
						...
						<ol class="breadcrumb page-breadcrumb pull-right">
							<li><a href="#">Home</a></li>
							<li class="active">Listing page</li>
						</ol>
					</div>
				</div>
			</div><!-- Banner Inner /- -->
			...
			<div class="container">
				<div class="property-left col-md-9 col-sm-6 p_l_z content-area">
					...
					<div class="property-listing-box sale-block">
						...
						<div class="property-main-box">
							<div class="col-md-4 p_z">
								<a title="Property Image" href="#"><img src="images/aa-listing/property1.jpg" alt="property1"></a>
							</div>
					...
					<div class="property-listing-box rent-block">
						...
						<div class="property-main-box">
							<div class="col-md-4 p_z ">
								<a title="Property Image" href="#"><img src="images/aa-listing/property2.jpg" alt="property2"></a>
							</div>
							<div class="col-md-8 p_z">
								<div class="property-details">
									<span>r</span>
					...
					<div class="property-listing-box sale-block">
						...
						<div class="property-main-box">
							<div class="col-md-4 p_z">
								<a title="Property Image" href="#"><img src="images/aa-listing/property3.jpg" alt="property1"></a>
							</div>
							<div class="col-md-8 p_z">
								<div class="property-details">
									<span>s</span>
					...
					<div class="property-listing-box rent-block">
						...
						<div class="property-main-box">
							<div class="col-md-4 p_z ">
								<a title="Property Image" href="#"><img src="images/aa-listing/property4.jpg" alt="property2"></a>
							</div>
							<div class="col-md-8 p_z">
								<div class="property-details">
									<span>r</span>
					...
					<div class="property-listing-box sale-block">
						...
						<div class="property-main-box">
							<div class="col-md-4 p_z">
								<a title="Property Image" href="#"><img src="images/aa-listing/property5.jpg" alt="property1"></a>
							</div>
							<div class="col-md-8 p_z">
								<div class="property-details">
									<span>s</span>
